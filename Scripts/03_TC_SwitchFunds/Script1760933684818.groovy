...
WebUI.click(findTestObject('Object Repository/Page_/a__hyperlink_5'))

WebUI.setText(findTestObject('Object Repository/Page_/input__holder_no'), acc_no)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_/select__tmp_swo_fund_code'), funds_id_swo, true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_/select__tmp_swi_fund_code'), funds_id_swi, true)

WebUI.click(findTestObject('Object Repository/Page_/input__switch_in'))

WebUI.setText(findTestObject('Object Repository/Page_/input__switch_amount_in_baht'), amount)
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_/td_2'), funds_fullname_swo)

WebUI.verifyElementText(findTestObject('Object Repository/Page_/td_3'), funds_fullname_swi)

//WebUI.verifyElementText(findTestObject('Object Repository/Page_/td_4'), '100.00 บาท')

//WebUI.verifyElementText(findTestObject('Object Repository/Page_/td_5'), '20/10/202511:16 น.')
